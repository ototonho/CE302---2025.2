...
Como definido pelas instruções dadas pela proposta de trabalho, a formatação deste segue a ordem: Definição do Problema; Objetivos de Análise; Materiais e Métodos; Resultados e Discussão; Conclusão e Referências. Cada uma das partes integrantes da ordem originalmente indicada, naturalmente, apresenta suas próprias subseções, estas são: 
