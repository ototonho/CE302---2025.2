...
analise_por_continente <- analise_por_pais %>%
  mutate(
    continente = case_when(
      # === ASIA ===
      country_padrao %in% c("Japanese", "Indian", "Chinese", "Thai", "Filipino", "Vietnamese", "Korean", "Indonesian", "Turkish", "Malaysian", "Pakistani", "Iranian", "Israeli/Jewish", "Lebanese", "Syrian", "Yemeni", "Emirati", "Kuwaiti", "Omani", "Qatari", "Saudi Arabian", "Middle Eastern", "Persian", "Turkish") ~ "Asian",
      
      # === EUROPA ===
      country_padrao %in% c("British", "French", "German", "Irish", "Italian", "Spanish", "Scandinavian Region", "Greek", "Swiss", "Dutch", "Austrian", "Portuguese", "Russian", "Belgian", "Hungarian", "Polish", "Czech", "Slovakian", "Romanian", "Ukrainian", "Scandinavian") ~ "European",
      ...
      # === OCEANIA ===
      country_padrao %in% c("Australian/New Zealand", "Fijian", "Samoan") ~ "Oceania",
