...
Matrizes são um simples extensão dos vetores. São vetores com dimensão (número de linhas e colunas). Todos os elementos de uma matriz devem ser do mesmo tipo.
...
A classe factor é similar a character no entanto permite denir ordem. Por exemplo:
