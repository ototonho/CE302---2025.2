...
valor_final <- ifelse (((valor_compra > 100) & (valor_compra < 299)), valor_compra * 0.95, 
                       ifelse((valor_compra >= 300), valor_compra * 0.85, valor_compra))
...
- Crie uma Função chamada classificar_triangulo que aceite três argumentos: lado_a, lado_b e lado_c.
...
-Tratamento de Exceção: Antes da classificação, inclua uma regra simples para verificar se os lados formam um triângulo válido: A soma de dois lados deve ser maior que o terceiro. Se for inválido, use warning() com a mensagem "Aviso: Os lados não formam um triângulo válido." e retorne NA.

```{r}

classificar_triangulo <- function(lado_a, lado_b, lado_c) {
